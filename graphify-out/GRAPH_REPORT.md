...
## Corpus Check
- 75 files · ~239,579 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1201 nodes · 1813 edges · 101 communities (81 shown, 20 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14d34539`
...
1. `Project Progress — Ford Mustang Mach-E 2026 First Responder RAG Portal` - 35 edges
2. `HudSystem` - 29 edges
3. `VrInput` - 29 edges
...
Cohesion: 0.15
Nodes (25): addMessage(), addTyping(), askQuickQuestion(), autoGrow(), clearBtn, clearConversation(), errorEl, focusInput() (+17 more)

### Community 1 - "HUD & Videosphere Rendering"
Cohesion: 0.11
Nodes (11): HudState, HudSystem, getChatHistory(), setChatExpandHandler(), setTranscriptListener(), probeString(), RendererProbe, pttStopWasRecent() (+3 more)
...
Cohesion: 0.14
Nodes (21): icon(), IconName, PATHS, activatePanorama(), bindVideoControls(), createHiddenVideoEls(), hlsInstances, hlsReady (+13 more)
...
Cohesion: 0.12
Nodes (25): setInputValue(), n8n chat WEBHOOK_URL, flashHudStatus(), requestChatExpand(), setErrorBanner(), PushToTalkSystem, ensureHls(), errorEl (+17 more)
...
Cohesion: 0.17
Nodes (3): bindingRows(), HelpPanel, InputMode

### Community 65 - "Community 65"
Cohesion: 0.13
Nodes (8): HandEvent, HandInput, HandSpace, JOINTS, TrackedJoint, InputSourceLike, SlotKind, SlotState
...
Cohesion: 0.13
Nodes (18): C, CanvasSurface, fitText(), Rect, roundRect(), SurfaceFilter, wrapText(), planeFor() (+10 more)
...
Cohesion: 0.29
Nodes (5): HandRig, ROLL_AXIS, Row, ROWS, RowSpec
...
Cohesion: 0.33
Nodes (6): 2026-09-08 — Hide the whole in-VR HUD, with a coach mark pointing at the button, Shipped, Still device-only, The panel-scale lock, generalized, Verified in the IWER emulator, not assumed, What changed
...
## Knowledge Gaps
- **512 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+507 more)
...
- **Why does `InputSources` connect `Community 54` to `Community 65`, `Community 43`, `Community 61`, `Community 88`, `Community 25`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Project Progress — Ford Mustang Mach-E 2026 First Responder RAG Portal` connect `Community 62` to `Community 166`, `Community 198`, `n8n Workflow Patterns`, `Community 107`, `Community 74`, `Community 14`, `Community 47`, `Community 49`, `Community 23`, `Community 24`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 94`?**
